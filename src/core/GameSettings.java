...
public class GameSettings {
    ...
    public void applyResolution(int width, int height, boolean fullscreen) {
        ...
        System.out.println("System: update resolution to " + width + "x" + height + " | Fullscreen: " + fullscreen);
    ...
    private void saveSettings() {
        ...
        try (FileOutputStream out = new FileOutputStream(CONFIG_FILE)) {
            ...
            System.out.println("error to save settings: " + e.getMessage());
        }
    }
    ...
    private void loadSettings() {
        ...
        try (FileInputStream in = new FileInputStream(CONFIG_FILE)) {
            ...
            System.out.println("error to load settings: " + e.getMessage());
